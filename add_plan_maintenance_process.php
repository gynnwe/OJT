...
if (isset($_SESSION['user_id'])) {
    ...
    try {
        ...
        function saveMaintenancePlan($conn, $year, $totalPlannedCount, $id)
        {
            ...
            $stmt->execute([
                ':adminId' => $id, // Replace with dynamic admin ID as required
                ':year' => $year,
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($yearMaintained && !empty($equipmentTypes) && !empty($counts)) {
                ...
                try {
                    ...
                    $maintenancePlanId = saveMaintenancePlan($conn, $yearMaintained, $totalPlannedCount, $user_id);
