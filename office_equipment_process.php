...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $equipment_type = $_POST['equipment_type']; // This will always be 'Office'
    ...
    try {
        ...
        $sql = "INSERT INTO office_equipment (location_id, equipment_type, equipment_name, equipment_serial_num, model_name, status)
        ...
        echo "Office equipment data inserted successfully!";
